    ...
    <body background="<c:url value="/resources/pics/background5.png" />">
		...
		<div class="polaroid_agency">
		  <div class="container3">
			<h3 id="titl">STEP 3</h3>
		     <form action="/action_page.php">
		     	<div class="fillers">
				     <label for="bedrooms">BEDROOMS</label>		    		 
		    		 <input type="text" id="bedrooms" name="bedrooms" placeholder="Bedroom count...">
		    		 <label for="bathrooms">BATHROOMS</label>	 
		    		 <input type="text" id="bathrooms" name="bathrooms" placeholder="Bathroom count...">
		    		 <label for="floor_size">FLOOR SIZE</label>	 
		    		 <input type="text" id="floor_size" name="floor_size" placeholder="Floor size in m2...">
		    		 <label for="parking">PARKING</label>	 
		    		 <input type="text" id="parking" name="parking" placeholder="Parking count...">
		    		 <a class="button" href="./publish4">NEXT</a>
	    		 </div>
